...
public class UserSignUpRequest {
    ...
    @Parameter(name = "이메일", description = "사용하려는 이메일", required = true, example = "test@naver.com")
    private String email;

    @ValidPassword
    @NotBlank(message = "비밀번호가 입력되지 않았습니다.")
    @Parameter(name = "비밀번호", description = "사용하려는 비밀번호", required = true, example = "testPassword")
    private String password;

    @ValidNickname
    @NotBlank(message = "닉네임이 입력되지 않았습니다.")
    @Parameter(name = "닉네임", description = "사용하려는 닉네임", required = true, example = "testNickname")
    private String nickname;

    @NotBlank(message = "이름이 입력되지 않았습니다.")
    @Parameter(name = "본명", description = "유저의 본명", required = true, example = "김철수")
    private String name;
    ...
    @Parameter(
            name = "생일",
            description = "YYYY-MM-DD 형태의 유저 생년월일",
            required = true,
            example = "2023-08-14")
    ...
    @Parameter(
            name = "성별",
            description = "유저 성별 / '남성' 혹은 '여성' 입력가능",
            required = true,
            example = "여성")
    private UserSex sex;
    ...
    @Parameter(name = "이용 약관 동의 여부", description = "이용 약관 동의 여부", required = true, example = "true")
